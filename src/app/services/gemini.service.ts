...
export class GeminiService {
  ...
  analyzeApiError(apiResponse: any): Observable<string> {
    const requestBody = {
      contents: [
        {
          parts: [
            {
              text: `Primesc următorul răspuns de la un API:\n\n${JSON.stringify(
                apiResponse,
                null,
                2
              )}\n\n
              ✅ Identifică problema principală și răspunde cu un singur string foarte scurt, pe înțelesul utilizatorului.`,
            },
          ],
        },
      ],
